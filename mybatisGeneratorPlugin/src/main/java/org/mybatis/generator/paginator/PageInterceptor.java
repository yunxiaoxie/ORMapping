...
public class PageInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		if (page != null) {
			...
			BoundSql countBS = copyBoundSql(mappedStatement, boundSql,
					countSql);
			...
			sb.append(boundSql.getSql()).append(" limit ").append(offset).append(",")
					.append(page.getPageSize());
			BoundSql newBoundSql = copyBoundSql(mappedStatement, boundSql,
					sb.toString());
	 ...
	 * 复制BoundSql对象
	 */
	private BoundSql copyBoundSql(MappedStatement ms, BoundSql boundSql,
			String countSql) {
		BoundSql newBoundSql = new BoundSql(ms.getConfiguration(), countSql,
